...
class QuizInformation extends Component {
  ...
  alertUser() {
    alert('Thank you for trying out the UPS Sort Application!');
  }
      ...
      <div className='quiz-information'>
        ...
        <div className='quiz-results row'>
          <div className='result-box result-box-correct six columns'>
            <h6>
              <i id='result-correct' className='fas fa-check' /> Correct
            </h6>
            <h2>{correct}</h2>
          </div>
          <div className='result-box result-box-incorrect six columns'>
            <h6>
              <i id='result-incorrect' className='fas fa-times' /> Incorrect
            </h6>
            <h2>{incorrect}</h2>
          </div>
        </div>
        <button onClick={this.alertUser.bind(this)}>Submit Results</button>
      </div>
    );
  }
}
